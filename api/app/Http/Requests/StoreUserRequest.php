...
class StoreUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'documento' => ['required', 'regex:/^[1-9][0-9]*$/', 'numeric', 'unique:usuario,documento'],
            ...
            'email' => ['required', 'regex:/^[A-Za-z0-9._-]{1,64}@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$/', 'email:rfc,dns', 'min:12', 'max:150', new UniqueIgnoreCase('usuario', 'email')],
            'telefono' => ['required', 'regex:/^3\d{9}$/', 'digits:10', 'unique:usuario,telefono'],
    ...
    public function messages(): array
    {
        $messages = [
            ...
            'registro_profesional.regex' => 'El registro profesional debe ser maximo de 15 digitos numericos sin espacios ni puntos',
            'registro_profesional.digits_between' => 'El registro profesional debe tener entre 5 y 15 digitos',
