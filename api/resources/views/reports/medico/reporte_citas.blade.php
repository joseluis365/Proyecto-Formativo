...
<head>
    ...
    <style>
        ...
        .header h1 { margin: 5px 0; color: #1e40af; font-size: 20px; }
        .header h2 { margin: 0; font-size: 13px; text-transform: uppercase; color: #475569; }
        .logo { position: absolute; top: 0; left: 0; width: 60px; height: 60px; }
        
        .info-panel { clear: both; margin-bottom: 15px; background: #f8fafc; padding: 10px; border-radius: 8px; border: 1px solid #e2e8f0; }
        .info-panel p { margin: 4px 0; font-size: 10px; color: #64748b; }
        .info-panel strong { color: #334155; }
        
        table { width: 100%; border-collapse: collapse; margin-top: 10px; table-layout: fixed; }
        th { background-color: #f1f5f9; color: #334155; font-weight: bold; padding: 8px; border: 1px solid #cbd5e1; text-align: left; text-transform: uppercase; font-size: 9px; }
        td { border: 1px solid #cbd5e1; padding: 7px; color: #475569; font-size: 10px; vertical-align: top; word-wrap: break-word; overflow-wrap: break-word; }
        tr:nth-child(even) { background-color: #fbfcfd; }
        
        .footer { position: fixed; bottom: -20px; left: 0px; right: 0px; height: 30px; text-align: center; font-size: 8px; color: #94a3b8; border-top: 1px solid #e2e8f0; padding-top: 5px; }
        .badge { padding: 3px 6px; border-radius: 4px; font-weight: bold; font-size: 8px; display: inline-block; text-align: center; }
...
<body>
    ...
    <div class="footer">
        Saluvanta EPS - Software Sanitech - Reporte generado por el profesional médico - Confidencial
    </div>
</body>
</html>
