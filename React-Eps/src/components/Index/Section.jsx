...
export default function Section({image, title, subtitle, description}) {
    return (
        <section className="px-6 md:px-10 lg:px-40 pt-8 pb-14 md:pt-10 md:pb-16 bg-white dark:bg-gray-900 @container overflow-visible">
            <div className="max-w-[1280px] mx-auto flex flex-col gap-8 @[864px]:flex-row @[864px]:items-center">
                ...
                <div className="flex-1 relative lg:max-w-[480px]">
                    <div className="w-full aspect-video md:aspect-4/3 bg-primary/5 rounded-2xl overflow-hidden border-4 border-white dark:border-slate-600 shadow-xl rotate-1">
                    ...
                    <div className="absolute -bottom-4 -left-4 bg-white dark:bg-slate-700 p-4 rounded-xl shadow-lg flex items-center gap-3 border border-slate-100 dark:border-slate-600 z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-500 dark:text-gray-300">ISO 9001 Calidad</p>
                        </div>
                    </div>
                </div>
            </div>
