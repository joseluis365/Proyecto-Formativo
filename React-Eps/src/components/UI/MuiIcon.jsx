...
const iconMapping = {
  ...
  visibility_off: VisibilityOffRoundedIcon,
  ...
  enterprise: CorporateFareRoundedIcon,
  ...
  workspace_premium: WorkspacePremiumRoundedIcon,
  license: WorkspacePremiumRoundedIcon,
  admin_panel_settings: AdminPanelSettingsRoundedIcon,
  settings_accessibility: AdminPanelSettingsRoundedIcon,
  local_pharmacy: LocalPharmacyRoundedIcon,
  show_chart: ShowChartRoundedIcon,
  monitoring: ShowChartRoundedIcon,
  history: HistoryRoundedIcon,
  history_toggle_off: HistoryRoundedIcon,
  monitor_heart: MonitorHeartRoundedIcon,
  medical_services: MedicalServicesRoundedIcon,
  task_alt: TaskAltRoundedIcon,
  history_edu: HistoryEduRoundedIcon,
  verified: VerifiedRoundedIcon,
  reply: ReplyRoundedIcon,
  attach_file: AttachFileRoundedIcon,
  medication: MedicationRoundedIcon,
  healing: HealingRoundedIcon,
  stethoscope: HealingRoundedIcon,
  upload_file: UploadFileRoundedIcon,
  cloud_upload: CloudUploadRoundedIcon,
  ...
  location_on: LocationOnRoundedIcon,
  email: EmailRoundedIcon,
  mail: EmailRoundedIcon,
  phone: PhoneRoundedIcon,
  account_circle: AccountCircleRoundedIcon,
  assignment: AssignmentRoundedIcon,
  markunread_mailbox: MarkunreadMailboxRoundedIcon,
  map: MapRoundedIcon,
  pin: PinDropRoundedIcon,
  store: StoreRoundedIcon,
  schedule: ScheduleRoundedIcon,
  '24mp': HourglassEmptyRoundedIcon,
