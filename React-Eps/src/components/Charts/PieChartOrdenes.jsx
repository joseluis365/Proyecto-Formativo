...
export default function PieChartOrdenes({ data }) {
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-neutral-gray-border/20 dark:border-gray-800 p-6 bg-white dark:bg-gray-800 shadow-sm h-[400px] min-h-[400px]">
