...
export default function SuperAdminCiudades() {
    ...
    const {
        ...
        setSearch,
        fetchData: fetchData
    } = useSuperAdminTableData("/configuracion/ciudades");
    ...
    const columns = [
        {
            key: "codigo_postal",
            header: "Cód. Postal",
            render: (item) => <span className="text-xs text-gray-500 font-mono">{item.codigo_postal}</span>
        },
        {
            key: "nombre",
        ...
        },
        {
            ...
            header: "Departamento",
            render: (item) => <span>{item.departamento_nombre || "N/A"}</span>
        },
        {
            key: "id_estado",
            header: "Estado",
    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-xl">
            <div className="flex flex-wrap justify-between items-center gap-4 mb-8">
                <PrincipalText icon="location_city" text="Gestión de Ciudades (SuperAdmin)" number={total} />
                <div className="w-sl">
