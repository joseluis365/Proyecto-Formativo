...
import SuperAdminRolModal from "@/components/Modals/SuperAdmin/SuperAdminRolModal";
...
export default function SuperAdminRoles() {
    ...
    } = useSuperAdminTableData("/configuracion/roles");
    ...
    const columns = [
        {
            key: "id_rol",
            header: "ID",
            render: (item) => <span className="text-xs text-gray-500 font-mono">{item.id_rol}</span>
        },
        {
            key: "tipo_usu",
            header: "Nombre del Rol",
            render: (item) => <span className="font-semibold">{item.tipo_usu}</span>
        },
        {
            key: "id_estado",
            header: "Estado",
    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-xl">
            <div className="flex flex-wrap justify-between items-center gap-4 mb-8">
                <PrincipalText icon="group" text="Gestión de Roles (SuperAdmin)" number={total} />
                <div className="w-sl">
