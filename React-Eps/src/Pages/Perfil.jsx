            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        {/* Sexo, fecha nacimiento y grupo sanguíneo solo para roles distintos al administrador */}
                        {rolId !== 2 && (
                            <>
                                <SelectField
                                    label="Sexo"
                        ...
                        {rolId === 5 && (
                            <div className="flex flex-col gap-1">
                                <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Farmacia Asignada</label>
                                <p className="px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white text-sm border border-transparent">
                                    {user.farmacia?.nombre || <span className="text-gray-400 italic">Sin asignar</span>}
                                </p>
                            </div>
                        )}
                    </div>
