...
export default function IndexPaciente() {
    ...
    }, [setTitle, user.primer_nombre, setSubtitle]);
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {cards.map((card, i) => (
                    ...
                    >
                        <Link
                            to={card.to}
                            className="block bg-white dark:bg-gray-900 p-8 rounded-[2rem] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group overflow-hidden relative border border-gray-100 dark:border-gray-800"
                        >
